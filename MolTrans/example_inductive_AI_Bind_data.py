...
def main(fold_n, lr):
    ...
    unique_smiles = list(set(df_all['SMILES'].tolist()))
    unique_seq = list(set(df_all['Target Sequence'].tolist()))

    all_smiles['SMILES'] = unique_smiles
    all_seq['Target Sequence'] = unique_seq
